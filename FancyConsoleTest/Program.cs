    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                FancyConsole.FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Bold)
                {
                ...
                FancyConsole.FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Italic)
                {
                ...
                FancyConsole.FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Underline)
                {
                ...
                FancyConsole.FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Strikethrough)
                {
                ...
                FancyConsole.FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Obfuscated)
                {
