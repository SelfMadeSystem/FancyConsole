...
using FancyConsoleTest.FancyConsole;
...
namespace ConsoleApplication1
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                FancyConsole.Init();
                new Thread(FancyConsole.StartInput).Start();
                FancyConsole.Log(new FancyText("[Warning] ", FancyColor.Yellow)
                {
                    Next = new FancyText("Resizing of window will cause issues. Press Ctrl-R to refresh screen.", FancyColor.Reset)
                });
                FancyConsole.Log(new FancyText("[Warning] ", FancyColor.Yellow)
                {
                    Next = new FancyText("If you are running this in Rider, there will be bugs!!!", FancyColor.Reset)
                });
                /*for (var i = 0; i < 200; i++)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Bold)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Italic)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Underline)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Strikethrough)
                {
                ...
                FancyConsole.Log(new FancyText("Black ", FancyColor.Black, FancyColor.Obfuscated)
                {
